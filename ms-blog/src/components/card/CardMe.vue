<template>
  <el-card>
    ...
    <div class="me-author-description">
      <span><i class="el-icon-location-outline"></i> &nbsp;湖南&长沙</span>
...
<script>
  export default {
    ...
    data() {
      return {
        qq: {title: 'QQ', message: '1677654285'},
        bilibili: {
          title: '哔哩哔哩',
          message: '<a target="_blank" href="https://www.bilibili.com/">https://www.bilibili.com/</a>'
        }
      }
    },
    methods: {
